...
import (
	...
	"github.com/gkwa/alittlepaintball/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.alittlepaintball.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".alittlepaintball")
	}
